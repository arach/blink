...
export function PermissionPrompt({
  ...
  return (
    <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-card border border-border/30 rounded-lg shadow-xl max-w-md w-full p-6">
        {/* Header */}
        ...
        <div className="space-y-4 mb-6">
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            global shortcuts like <kbd className="px-1.5 py-0.5 bg-background border border-border/30 rounded text-xs">⌘⌃⌥⇧N</kbd> for 
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 bg-primary text-primary-foreground hover:bg-primary/90 px-4 py-2 rounded text-sm font-medium transition-colors"
          >
            Open Settings
          </button>
          <button
            onClick={onDismiss}
            className="px-4 py-2 text-muted-foreground hover:text-foreground border border-border/30 hover:bg-background/60 rounded text-sm transition-colors"
          >
            Later
          </button>
        </div>
        ...
        <button
          onClick={onDismiss}
          className="absolute top-4 right-4 text-muted-foreground/60 hover:text-foreground p-1 rounded transition-colors"
        >
